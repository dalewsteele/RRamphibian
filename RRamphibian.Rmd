...
## Master's Thesis | Emacs/ESS/Sweave/LaTeX/pdf
...
## Literate Programming | integrade code, plain text and figures
* ![Image](Images\txt.png)
...
## New workflow |R/RStudio (knitr/pandoc)
...
* Combine
    - R code (and now other code 'engines' including SAS, python, awk)
    - Text markup language: LaTeX, rmarkdown

* Output (after weave or knit): pdf, web pages, MSWord, slides
...
The Monte Carlo estimate for $\pi$ is `r pi_1000`.
...
```{r fig.width=9, fig.height=6, echo=FALSE}
img <- readPNG("Images\\my_github.png")
grid.raster(img)
```
...
* Opensource, relies on a complex, rapidly changing toolchain (knitr, rmarkdown, markdown,  
